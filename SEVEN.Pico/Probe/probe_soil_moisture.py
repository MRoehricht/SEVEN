...
def loop():
    while True:
      ...
      #print(values) 
      json = 'http://192.168.178.4:8055/measurement/create/%7B%22ProbeId%22%3A%20%227a73f8ae-0000-0000-bbbb-7ab5a00a9c1d%22%2C%20%22MeasurementItems%22%3A%5B%20%7B%22Type%22%3A64%2C%22Value%22%3A%22' + str(value_percentage) +'%22%7D%5D%7D'
